...
class BeerControllerIT {
    ...
    void testUpdateBeerBadVersion() throws Exception {
        ...
        MvcResult result = mockMvc.perform(put(BeerController.BEER_BY_ID_URI, beer.getId())
        ...
        MvcResult result2 = mockMvc.perform(put(BeerController.BEER_BY_ID_URI, beer.getId())
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(beerDTO)))
                .andExpect(status().isNoContent())
    ...
    @Test
    void testListBeers() {
        Page<BeerDTO> dtos = beerController.listBeers(null, null, false, 1, 3000);
